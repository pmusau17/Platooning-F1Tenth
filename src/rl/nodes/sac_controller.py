...
if __name__ == '__main__':
    rospy.init_node('sac_controller', anonymous=True)
    package_path=rospkg.RosPack().get_path('rl')
    load_name = os.path.join(package_path,"sac_control","final_models","final_model.pth")
    ...
    extendObj = SACController(policy_file_name=load_name, lidar_sub_name=lidar_sub_name, 
