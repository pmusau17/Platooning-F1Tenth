...
const rtreach::angle_msg::ConstPtr& angle_msg, const rtreach::reach_tube::ConstPtr& obs1, const rtreach::reach_tube::ConstPtr& obs2,const rtreach::reach_tube::ConstPtr& wall)//,const rtreach::obstacle_list::ConstPtr& obs_msg)
{
    using std::cout;
    using std::endl;
    ...
    if(debug){
        ...
        for(int i = 0; i<std::min(rect_count,max_hyper_rectangles)-5;i+=10)
        {
...
int main(int argc, char **argv)
{
    ...
    message_filters::Subscriber<rtreach::reach_tube> obs1(n,"racecar2/reach_tube",10);
    ...
    typedef sync_policies::ApproximateTime<nav_msgs::Odometry, rtreach::velocity_msg, rtreach::angle_msg,rtreach::reach_tube,rtreach::reach_tube,rtreach::reach_tube> MySyncPolicy; 

    // ApproximateTime takes a queue size as its constructor argument, hence MySyncPolicy(10)
    Synchronizer<MySyncPolicy> sync(MySyncPolicy(100), odom_sub, vel_sub,angle_sub,obs1,obs2,wall);//,interval_sub);
