...
int main(int argc, char **argv)
{
    ...
    std::string position_uncertainty;
    std::string velocity_uncertainty;
    ...
    if(argv[8] == NULL)
    {
        std::cout << "Please give the position uncertainty" << std::endl;
        exit(0);
    }

    if(argv[9] == NULL)
    {
        std::cout << "Please give the velocity uncertainty" << std::endl;
        exit(0);
    }
    ...
    position_uncertainty = argv[8];

    velocity_uncertainty = argv[9];
    ...
    while(ros::ok())
    {
     ...
     save_path = path + "/"+"nosimplex_"+controller_name+"_"+std::to_string(sim_time)+"_"+number_of_opponents+"_"+number_of_obstacles+"_"+position_uncertainty+"_"+velocity_uncertainty+"_"+std::to_string(speed_setpoint)+".csv";
