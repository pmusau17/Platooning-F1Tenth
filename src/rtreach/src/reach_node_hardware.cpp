...
int main(int argc, char **argv)
{
    ...
    std::string racecar1, racecar2,ego_vehicle;
    // initialize the ros node
    ros::init(argc, argv, "reach_node_hardware");
    ...
    message_filters::Subscriber<rtreach::reach_tube> obs1(n,racecar1+"/reach_tube",10);
    message_filters::Subscriber<rtreach::reach_tube> obs2(n,racecar2+"/reach_tube",10);
