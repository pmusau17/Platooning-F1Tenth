...
```
pip install cython
git clone https://github.com/pmusau17/range_libc -b python3
...
```
**Note:** If the installation fails because of permissions change the ownership of the build folder to user ie ```$ sudo chown $USER -R build```
# Usage
