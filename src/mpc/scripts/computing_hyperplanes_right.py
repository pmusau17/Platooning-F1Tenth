...
def find_constraints_right(ego_x, ego_y, head_angle, array_left, array_right, tarx, tary, ego_cc):
 ...
 # initial guesses
    ...
    solution = minimize(objective, x0, args=(array_left, array_right, ego_cc), method='SLSQP', bounds=bnds, constraints=cons)
    x = solution.x
