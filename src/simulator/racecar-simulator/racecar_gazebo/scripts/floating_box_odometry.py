...
class OdometryNode:
    ...
    def __init__(self,box_name):
        ...
        self.pub_odom = rospy.Publisher(self.box_name+'/odom', Odometry, queue_size=1)
    ...
    def sub_robot_pose_update(self, msg):
        ...
        try:
            arrayIndex = msg.name.index(self.box_name+'::base_footprint')
    ...
    def timer_callback(self, event):
        ...
        cmd.child_frame_id = self.box_name+'/base_footprint' # This used to be odom
...
if __name__ == '__main__':
    rospy.init_node("floating_box_odometry_node")
    args = rospy.myargv()[1:]
