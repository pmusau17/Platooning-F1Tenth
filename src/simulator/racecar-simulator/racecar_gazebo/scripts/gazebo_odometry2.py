...
class OdometryNode:
    # Set publishers
    pub_odom = rospy.Publisher('/vesc/odom2', Odometry, queue_size=1)
    ...
    def sub_robot_pose_update(self, msg):
        ...
        try:
            arrayIndex = msg.name.index('racecar2::base_link')
    ...
    def timer_callback(self, event):
        ...
        cmd.child_frame_id = 'base_link2' # This used to be odom
